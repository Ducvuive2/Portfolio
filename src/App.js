    ...
    <div className="flex justify-between w-2/3 mx-auto mt-15">
      <div className="sticky flex flex-col items-center w-1/3 mt-5 shadow-2xl bg-background-sidebar text-text rounded-2xl top-5 h-fit p-15">
        <div className="text-center">
          <a href="/images/Dylann.webp" target="_blank" rel="noopener noreferrer" title="Nguyen Vu Van Duc - Software Engineer">
            <img 
          ...
          <p className="bg-background-hover px-2.5 py-1.5 rounded text-sm mb-5 mt-2">Software Engineer</p>
